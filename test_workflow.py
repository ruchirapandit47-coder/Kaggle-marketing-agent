...
async def main():
    ...
    print(f"Final State creative_assets keys: {list(ctx.session.state.get('creative_assets', {}).keys())}")
    print(f"Final State campaign_theme: {ctx.session.state.get('creative_assets', {}).get('campaign_theme')}")
